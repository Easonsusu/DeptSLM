...
Generation-contract failures remain distinguishable from retrieval failures: their retrieval metrics are computed from the authorized trace, but their invalid-contract rate prevents a misleadingly successful gate when the suite's bound is exceeded.
