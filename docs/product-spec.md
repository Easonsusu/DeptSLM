...
## Roadmap v2 Phase 14 status

Roadmap v1 Phase 0–13 is complete. Phase 14.0 is complete and Phase 14.1 is
the current metadata-only controlled execution plane. Phase 11 remains the source of one
...
boundary for externally produced adapters. Phase 14.1 adds no training,
LlamaFactory execution, model download, real runtime, or automatic handoff.
A future Phase 14.2/14.3 implementation
